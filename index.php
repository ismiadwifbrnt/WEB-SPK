      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="basic_table_saw.php">SAW</a></li>
              <li><a href="basic_table_wp.php">WP</a></li>
              <li><a href="basic_table_ahp.php">AHP</a></li>
              <li><a href="basic_table_electree.php">ELECTREE</a></li>
              <li><a href="basic_table_topsis.php">TOPSIS</a></li>
              <li><a href="basic_table_moora.php">MOORA</a></li>
              <li><a href="basic_table_.gdss.php">GDSS</a></li>
